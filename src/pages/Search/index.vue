...
export default {
  ...
  beforeMount() {
    ...
    this.isprice = !this.iscom;
    // 发请求之前我们要先整合一下参数，因为这个参数包括了苏偶有的搜索参数，首页keyword，typenav的选择，还有当前自己页面的选择
  ...
  watch: {
    $route: {
      handler(nv, ov) {
        // 首先我们要知道路由变化我们就应该重新发请求，
        // 但重新发起请求，之前应先删去之前不需要的请求信息，前后应该无所谓重置一下，然后整理参数
  ...
  methods: {
    ...
    changePagination(currentNo) {
      this.SearchParams.pageNo = currentNo;
      this.getData();
    },
  },
};
