<template>
  <!-- 就两个地方要活数据 -->
  <div class="pay-main">
    <el-button type="primary" icon="el-icon-platform-eleme">测试</el-button>
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a @click="open" class="btn" to="/paysuccess">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
      ...
      this.$alert(`<img src=${url} />`, "HTML 片段", {
        ...
        .then(() => {
          let timer = setInterval(async () => {
            let res = await this.$API.getpayState(this.orderId);
            console.log(res);
            if (res.code == 200) {
              clearInterval(timer);
